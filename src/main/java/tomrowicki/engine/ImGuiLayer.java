...
import tomrowicki.editor.MenuBar;
import tomrowicki.editor.PropertiesWindow;
import tomrowicki.editor.SceneHierarchyWindow;
...
public class ImGuiLayer {
    ...
    public void initImGui() {
        ...
        io.setIniFilename("imgui.ini"); // We don't want to save .ini file (outdated comment)
