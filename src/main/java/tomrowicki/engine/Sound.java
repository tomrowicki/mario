...
public class Sound {
    ...
    public Sound(String filepath, boolean loops) {
        ...
        if (rawAudioBuffer == null) {
            System.err.println("Error: couldn't load sound file " + filepath);
            stackPop();
            stackPop();
            return;
        }

        // Retrieve extra info from the buffers
    ...
    public void play() {
        ...
        if (state == AL_STOPPED) {
            isPlaying = false;
            alSourcei(sourceId, AL_POSITION, 0); // resetting to the beginning
        }
